...
CREATE TABLE `bajas_periodo` (
  `numero_control` varchar(40) NOT NULL,
  PRIMARY KEY (`numero_control`),
  CONSTRAINT `nc` FOREIGN KEY (`numero_control`) REFERENCES `alumnos` (`numero_control`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `currentperiodo` VALUES ('gf');
...
INSERT INTO `periodos` VALUES ('Ago21-Dic21',1),('gf',0);
...
-- Dump completed on 2022-03-01  4:38:55
